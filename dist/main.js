...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list.js */ \"./src/list.js\");\n\n\n\n\n// DOM manipulation\n\nconst modal = document.querySelector('#modal');\nconst openModal = document.querySelector(\"#add-item\");\nconst closeModal = document.querySelector(\"#close-modal\");\n\nopenModal.addEventListener('click', () => modal.showModal());\ncloseModal.addEventListener('click', () => modal.close());\n\nconst submit = document.querySelector('#submit');\n\nsubmit.addEventListener('click', () => {\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.list.addItem();\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.handleDOM.renderList();\n    modal.close()\n});\n\nconst newProject = document.querySelector(\"#new-project\");\nconst projectModal = document.querySelector(\"#project-modal\");\nconst closeProjectModal = document.querySelector(\"#close-project-modal\");\n\nnewProject.addEventListener('click', () => {\n    projectModal.showModal();\n});\n\ncloseProjectModal.addEventListener('click', () => {\n    projectModal.close();\n});\n\nconst projectSubmit = document.querySelector('#project-submit');\n\nprojectSubmit.addEventListener('click', () => {\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.list.addProject();\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.handleDOM.renderProjects();\n    projectModal.close();\n});\n\nconst home = document.querySelector('#home');\n\nhome.addEventListener('click', () => {\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.list.projectSelect = false;\n    _list_js__WEBPACK_IMPORTED_MODULE_1__.handleDOM.renderList();\n    const page = document.querySelector('#page');\n    page.textContent = 'Home';\n});\n\nconst deleteProject = document.querySelector('#delete-project');\n\ndeleteProject.addEventListener('click', () => {\n    if (!_list_js__WEBPACK_IMPORTED_MODULE_1__.list.projectSelect) {\n        alert('Please select a project first');\n    } else {\n        _list_js__WEBPACK_IMPORTED_MODULE_1__.list.removeProjectAndNotes();\n        const page = document.querySelector('#page');\n        page.textContent = 'Home';\n        _list_js__WEBPACK_IMPORTED_MODULE_1__.list.projectSelect = '';\n        _list_js__WEBPACK_IMPORTED_MODULE_1__.handleDOM.renderProjects();\n        _list_js__WEBPACK_IMPORTED_MODULE_1__.handleDOM.renderList();\n    }\n});\n\n//# sourceURL=webpack://odin-todo-list/./src/index.js?");
